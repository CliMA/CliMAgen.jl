...
mpiexec julia --project analyze_downscaled_by_batch.jl 20 1
mpiexec julia --project analyze_downscaled_by_batch.jl 20 2
mpiexec julia --project analyze_downscaled_by_batch.jl 20 4
mpiexec julia --project analyze_downscaled_by_batch.jl 20 8
mpiexec julia --project analyze_downscaled_by_batch.jl 20 16
echo done
