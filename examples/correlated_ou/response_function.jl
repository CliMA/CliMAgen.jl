...
# reshape to 32x32x1xnobs
nobs = batchsize_1 * nbatches #size(data)[end]
data = reshape(data[:,:,1:nobs], (32,32,1,nobs))
...
hfile = h5open("/home/sandre/Repositories/CliMAgen.jl/response_function.h5", "cw")
