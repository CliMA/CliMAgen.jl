...
function run_analysis1(params; FT=Float32, logger=nothing)
    ...
    savefig("output_$(alpha)_$(beta)_$(gamma)_$(sigma)/center_pdfs.png")
    ...
    savefig("output_$(alpha)_$(beta)_$(gamma)_$(sigma)/edge_pdfs.png")
...
function run_analysis2(params; FT=Float32, logger=nothing)
    ...
    file_path = "data/data_$(alpha)_$(beta)_$(gamma)_$(sigma).hdf5"
    ...
    cum_samples = zeros(10)
    for i in 1:10
        cum_x[i] = cumulant(reshape(xtrain,(nsamples*size(x)[3])),i)
