...
xlims!(ax, colorrange)
save("samples_pr_temp_exp2.png", fig)
...
# xlims!(ax, 260, 280)
save("samples_hist_pr_temp_1_exp2.png", fig)
##
...
# xlims!(ax, 260, 280)
save("samples_hist_pr_temp_2_exp2.png", fig)
...
save("losses_pr_temp_exp2.png", fig)

using HDF5

hfile = h5open("temp_pr_samples_2.hdf5", "w")
