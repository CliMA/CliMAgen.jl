...
for factor in ProgressBar(factors)
    ...
    save(figure_directory  * "losses_double_gyre_$(casevar)_$(factor)_$(level_index).png", fig)
    ...
    save(figure_directory  * "double_gyre_samples_u_case_$(factor)_$(level_index).png", fig)
    ...
    save(figure_directory  * "double_gyre_samples_v_$(factor)_$(level_index).png", fig)
    ...
    save(figure_directory  * "double_gyre_samples_w_$(factor)_$(level_index).png", fig)
    ...
    save(figure_directory  * "double_gyre_samples_b_$(factor)_$(level_index).png", fig)
    ...
    save(figure_directory  * "double_gyre_mean_std_$(factor)_$(level_index).png", fig)
